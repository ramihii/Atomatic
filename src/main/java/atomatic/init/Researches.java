...
public class Researches
{
    ...
    private static void initQuantaResearch()
    {
        ...
        new ResearchItem(WEAK_PRIM_WATER, CATEGORY_QUANTA, new AspectList().add(Aspect.WATER, 2).add(Aspect.FIRE, 1), 7, -1, 1, ResourceLocationHelper.getResourceLocation(ICON_LOCATION + WEAK_PRIM_WATER.toLowerCase() + FILE_EXTENSION)).setParents(PRIMAL_REVERSION).setSecondary().setPages(new ResearchPage(PAGE_PREFIX + WEAK_PRIM_WATER + ".1"), new ResearchPage((InfusionRecipe) recipes.get(WEAK_PRIM_WATER))).registerResearchItem();
        new ResearchItem(WEAK_PRIM_EARTH, CATEGORY_QUANTA, new AspectList().add(Aspect.EARTH, 2).add(Aspect.AIR, 1), 7, 1, 1, ResourceLocationHelper.getResourceLocation(ICON_LOCATION + WEAK_PRIM_EARTH.toLowerCase() + FILE_EXTENSION)).setParents(PRIMAL_REVERSION).setSecondary().setConcealed().setPages(new ResearchPage(PAGE_PREFIX + WEAK_PRIM_EARTH + ".1"), new ResearchPage((InfusionRecipe) recipes.get(WEAK_PRIM_EARTH))).registerResearchItem();
        ...
        new ResearchItem(WEAK_PRIM_ENTROPY, CATEGORY_QUANTA, new AspectList().add(Aspect.ENTROPY, 2).add(Aspect.ORDER, 1), 5, 3, 1, ResourceLocationHelper.getResourceLocation(ICON_LOCATION + WEAK_PRIM_ENTROPY.toLowerCase() + FILE_EXTENSION)).setParents(PRIMAL_REVERSION).setSecondary().setConcealed().setPages(new ResearchPage(PAGE_PREFIX + WEAK_PRIM_ENTROPY + ".1"), new ResearchPage((InfusionRecipe) recipes.get(WEAK_PRIM_ENTROPY))).registerResearchItem();
    }
}
