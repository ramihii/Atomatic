...
public class Recipes
{
    ...
    private static void initInfusionRecipes()
    {
        ...
        Researches.recipes.put(Researches.WEAK_PRIM_WATER, ThaumcraftApi.addInfusionCraftingRecipe(Researches.WEAK_PRIM_WATER, new ItemStack(ModItems.weakPrimalObject, 1, 2), 5, new AspectList().add(Aspect.WATER, 32).add(Aspect.FIRE, 16), shard, new ItemStack[]{balancedShard, balancedShard, shard, shard, shard, shard, new ItemStack(Items.water_bucket), new ItemStack(Items.water_bucket)}));
        shard = ItemApi.getItem("itemShard", 3);
        Researches.recipes.put(Researches.WEAK_PRIM_EARTH, ThaumcraftApi.addInfusionCraftingRecipe(Researches.WEAK_PRIM_EARTH, new ItemStack(ModItems.weakPrimalObject, 1, 3), 5, new AspectList().add(Aspect.EARTH, 32).add(Aspect.AIR, 16), shard, new ItemStack[]{balancedShard, balancedShard, shard, shard, shard, shard, new ItemStack(Blocks.obsidian), new ItemStack(Blocks.obsidian)}));
        shard = ItemApi.getItem("itemShard", 4);
        Researches.recipes.put(Researches.WEAK_PRIM_ORDER, ThaumcraftApi.addInfusionCraftingRecipe(Researches.WEAK_PRIM_ORDER, new ItemStack(ModItems.weakPrimalObject, 1, 4), 5, new AspectList().add(Aspect.ORDER, 32).add(Aspect.ENTROPY, 16), shard, new ItemStack[]{balancedShard, balancedShard, shard, shard, shard, shard, new ItemStack(Blocks.sandstone, 1, 2), new ItemStack(Blocks.sandstone, 1, 2)}));
        shard = ItemApi.getItem("itemShard", 5);
        Researches.recipes.put(Researches.WEAK_PRIM_ENTROPY, ThaumcraftApi.addInfusionCraftingRecipe(Researches.WEAK_PRIM_ENTROPY, new ItemStack(ModItems.weakPrimalObject, 1, 5), 5, new AspectList().add(Aspect.ENTROPY, 32).add(Aspect.ORDER, 16), shard, new ItemStack[]{balancedShard, balancedShard, shard, shard, shard, shard, new ItemStack(Blocks.cactus), new ItemStack(Blocks.cactus)}));
    }
}
